...
const MANIFEST = {"version":"67be45cd","urls":["/","/assets/index-BKJLaKwn.js","/icons/apple-touch-icon.png","/icons/icon-192.png","/icons/icon-512.png","/icons/icon-maskable-512.png","/manifest.webmanifest"]} || { version: "dev", urls: ["/"] };
